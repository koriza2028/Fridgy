...
export default function IngredientItem({ ingredient, onRemove, isMandatory }) {
  ...
  const borderColor = ingredient.amount > 0 ? 'green' : 'red';
    ...
    return (
        <View style={[styles.IngredientItem, { borderColor: borderColor }]}>
            ...
            <Image style={styles.IngredientItem_Picture} source={require('../../../assets/ProductImages/banana_test.png')}></Image>
